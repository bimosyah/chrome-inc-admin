									...
									<fieldset class="border p-2">
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
												...
												value="<?php echo (isset($barang[0]->kode_barang) ? $barang[0]->kode_barang : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?> >
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-12">
												...
												value="<?php echo (isset($barang[0]->nama_barang) ? $barang[0]->nama_barang : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
											</div>
										</div>
									</fieldset>
								</div>
											...
											<div class="col-lg-4">
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->ongkos_seleb) ? $barang[0]->ongkos_seleb : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->bahan_seleb) ? $barang[0]->bahan_seleb : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->ongkos_crom) ? $barang[0]->ongkos_crom : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->bahan_crom) ? $barang[0]->bahan_crom : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
											</div>
											<div class="col-lg-4">
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->ongkos_hapus_cat) ? $barang[0]->ongkos_hapus_cat : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->marketing) ? $barang[0]->marketing : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->listrik) ? $barang[0]->listrik : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->pengepakan_barang) ? $barang[0]->pengepakan_barang : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
											</div>
											<div class="col-lg-4">
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->bonus) ? $barang[0]->bonus : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->peralatan) ? $barang[0]->peralatan : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														value="<?php echo (isset($barang[0]->omset_pabrik) ? $barang[0]->omset_pabrik : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
												<div class="form-group" <?php echo ($this->uri->segment(2) == "cek" ? 'style="display: none"' : "") ?>>
													...
													<div class="col-sm-12">
														...
														<input type="hidden" class="form-control" name="total_harga" id="total_harga" value="<?php echo (isset($barang[0]->total_harga) ? $barang[0]->total_harga : "") ?>" <?php echo ($this->uri->segment(2) == "cek" ? "disabled" : "" ) ?>>
													</div>
												</div>
											</div>
										</div>
