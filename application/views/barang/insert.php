			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card card-info">
						<?php echo ($this->uri->segment(2) == "edit" ? form_open('barang/update/'.$this->uri->segment(3), 'class="form-horizontal"') : form_open('barang/save', 'class="form-horizontal"')); ?>
						<div class="card-body">
							<div class="row">
								<div class="col-lg-4">
										...
										<div class="row">
											<div class="col-lg-4">
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="ongkos_seleb" id="ongkos_seleb" 
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="bahan_seleb" id="bahan_seleb" 
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="ongkos_crom" id="ongkos_crom" 
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="bahan_crom" id="bahan_crom" 
											...
											<div class="col-lg-4">
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="ongkos_hapus_cat" id="ongkos_hapus_cat" 
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="pengepakan_barang" id="pengepakan_barang" 
											...
											<div class="col-lg-4">
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="peralatan" id="peralatan" 
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<input type="text" class="form-control" name="omset_pabrik" id="omset_pabrik" 
